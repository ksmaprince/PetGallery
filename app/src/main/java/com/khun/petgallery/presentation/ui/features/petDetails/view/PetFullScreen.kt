package com.khun.petgallery.presentation.ui.features.petDetails.view
...
import com.khun.petgallery.presentation.ui.theme.favourite
import com.khun.petgallery.utils.Constants
import com.khun.petgallery.utils.TestTags
import com.khun.petgallery.utils.TestTags.BACK_NAVIGATION_ICON_DESCRIPTION
import com.khun.petgallery.utils.TestTags.FULL_SCREEN_APP_BAR
...
fun PetFullDetail(
    ...
    Scaffold( // in scaffold we are specifying top bar.
        topBar = { PetFullScreenAppBar(onBackPressed) }) {
        Surface(modifier = Modifier.padding(top = it.calculateTopPadding())) {
            PetDetails(url, isFavourite, favSelection)
        }
    }
}
...
@Composable
fun PetFullScreenAppBar(onBackPressed: () -> Unit) {

    // inside top bar we are specifying background color.
    TopAppBar(
        colors = centerAlignedTopAppBarColors(
            containerColor = colorResource(R.color.purple_500),
            titleContentColor = Color(R.color.purple_500),
...
@Composable
fun PetDetails(url: String?, isFavourite: Boolean, favSelection: (isFav: Boolean) -> Unit) {
    Box(
        modifier = Modifier
            .wrapContentHeight()
            .wrapContentWidth()
